...
\title[\LaTeX{} Template]{A \LaTeX{} Template for Reports} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Weiyong Zhang\\章维勇} % Your name
...
\medskip
\textit{zhangwya@gmail.com} % Your email address
}
